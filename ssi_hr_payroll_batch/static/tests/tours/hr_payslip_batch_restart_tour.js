odoo.define("ssi_hr_payroll_batch.hr_payslip_batch_restart_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the batch to restart. The Pre-Condition record (in
            // Cancelled status) is prepared in setUpClass and carries the type
            // "TOUR BATCH RESTART".
            {
                content: "Open the batch",
                trigger: ".o_data_row:contains(TOUR BATCH RESTART) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
