odoo.define("ssi_hr_payroll_batch.hr_payslip_batch_reject_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the batch to reject. The Pre-Condition record (in
            // Waiting for Approval, with admin as approver) is prepared in
            // setUpClass and carries the type "TOUR BATCH REJECT".
            {
                content: "Open the batch",
                trigger: ".o_data_row:contains(TOUR BATCH REJECT) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
