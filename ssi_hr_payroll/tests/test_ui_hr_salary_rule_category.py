...
class TestUiHrSalaryRuleCategory(HttpSavepointCase):
    ...
    def setUpClass(cls):
        ...
        # Pre-Condition for Generate Code (docs/hr_salary_rule_category/01-create.md
        ...
        cls.code_sequence = cls.env["ir.sequence"].create(
            {
                "name": "TOUR Salary Rule Category Code Sequence",
                "code": "ssi_hr_payroll.tour.hr_salary_rule_category",
                "prefix": "TOURSEQSRC",
                "padding": 4,
            }
        )
