odoo.define("ssi_hr_payroll.hr_payslip_approve_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the payslip to approve. The Pre-Condition record
            // (in Waiting for Approval, with admin as approver) is prepared in
            // setUpClass for employee "TOUR PAYSLIP APPROVE".
            {
                content: "Open the payslip",
                trigger:
                    ".o_data_row:contains(TOUR PAYSLIP APPROVE) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
