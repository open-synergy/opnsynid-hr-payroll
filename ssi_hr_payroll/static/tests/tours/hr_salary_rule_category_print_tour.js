odoo.define("ssi_hr_payroll.hr_salary_rule_category_print_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the salary rule category record to print.
            {
                content: "Open the salary rule category record",
                trigger:
                    ".o_data_row:contains(TOUR PRINT SALARY RULE CATEGORY) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Salary rule category form is displayed",
                trigger: ".o_form_view",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            ...
            // the salary rule category form is displayed again. Whether a report is
            // actually generated and downloaded is out of tour scope.
            {
                content:
                    "Wizard is closed and the salary rule category form is displayed",
                trigger: ".o_form_view",
