odoo.define("ssi_hr_payroll.hr_payslip_input_type_print_tour", function (require) {
    "use strict";

    var tour = require("web_tour.tour");

    // IK: docs/hr_payslip_input_type/06-print.md
    //
    ...
    tour.register(
        "ssi_hr_payroll_hr_payslip_input_type_print",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // ── Flow 2 — Open the payslip input type record to print.
            {
                content: "Open the payslip input type record",
                trigger:
                    ".o_data_row:contains(TOUR PRINT PAYSLIP INPUT TYPE) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Payslip input type form is displayed",
                trigger: ".o_form_view",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            ...
            // the payslip input type form is displayed again. Whether a report is
            // actually generated and downloaded is out of tour scope.
            {
                content:
                    "Wizard is closed and the payslip input type form is displayed",
                trigger: ".o_form_view",
