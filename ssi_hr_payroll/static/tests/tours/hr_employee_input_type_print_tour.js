odoo.define("ssi_hr_payroll.hr_employee_input_type_print_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the employee input type record to print.
            {
                content: "Open the employee input type record",
                trigger:
                    ".o_data_row:contains(TOUR PRINT EMPLOYEE INPUT TYPE) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Employee input type form is displayed",
                trigger: ".o_form_view",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            ...
            // the employee input type form is displayed again. Whether a
            // report is actually generated and downloaded is out of tour
            // scope.
            {
                content:
                    "Wizard is closed and the employee input type form is displayed",
                trigger: ".o_form_view",
