odoo.define("ssi_hr_payroll.hr_salary_contribution_print_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the salary contribution record to print.
            {
                content: "Open the salary contribution record",
                trigger:
                    ".o_data_row:contains(TOUR PRINT SALARY CONTRIBUTION) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Salary contribution form is displayed",
                trigger: ".o_form_view",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            ...
            // the salary contribution form is displayed again. Whether a report is
            // actually generated and downloaded is out of tour scope.
            {
                content:
                    "Wizard is closed and the salary contribution form is displayed",
                trigger: ".o_form_view",
