odoo.define("ssi_hr_payroll.hr_payslip_type_print_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the payslip type record to print.
            {
                content: "Open the payslip type record",
                trigger:
                    ".o_data_row:contains(TOUR PRINT PAYSLIP TYPE) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Payslip type form is displayed",
                trigger: ".o_form_view",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            ...
            // the payslip type form is displayed again. Whether a report is
            // actually generated and downloaded is out of tour scope.
            {
                content: "Wizard is closed and the payslip type form is displayed",
                trigger: ".o_form_view",
