odoo.define("ssi_hr_payroll.hr_salary_rule_print_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // ── Flow 2 — Open the salary rule record to print.
            {
                content: "Open the salary rule record",
                trigger:
                    ".o_data_row:contains(TOUR PRINT SALARY RULE) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Salary rule form is displayed",
                trigger: ".o_form_view",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            ...
            // the salary rule form is displayed again. Whether a report is
            // actually generated and downloaded is out of tour scope.
            {
                content: "Wizard is closed and the salary rule form is displayed",
                trigger: ".o_form_view",
