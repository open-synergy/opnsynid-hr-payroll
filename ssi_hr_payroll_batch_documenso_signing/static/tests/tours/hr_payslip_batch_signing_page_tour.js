odoo.define(
    "ssi_hr_payroll_batch_documenso_signing.hr_payslip_batch_signing_page_tour",
    function (require) {
        "use strict";
        ...
        // payslip batch form renders), then assert the delta: the Documenso
        // Signing page — visible tab label "Signature Requests" — is present in
        // the notebook. No external Documenso service is involved.
        tour.register(
            ...
            [
                ...
                {
                    content:
                        "The Documenso Signing tab (Signature Requests) is present",
                    trigger:
