...
> **Module:** ssi_hr_payroll_batch_documenso_signing **Extends:** ssi_hr_payroll_batch —
> model `hr_payslip_batch`, aksi `01-create`

## Modified Flow

- Anchor: on the base Flow step 2 (after clicking **New** / **Create** the payslip batch
  form opens in edit mode), the notebook gains an additional tab **Signature Requests**
  — the Documenso Signing page contributed by this module.
